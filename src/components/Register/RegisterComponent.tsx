...
let infoUser:UserData ={id:uuidv4(),full_name:"",date_incorporation:"",email:"",password : "",confirm_pass:""}
...
const RegisterComponent:React.FC = () =>{
    ...
    <div className='register_right'>
        ...
        <form action="" onSubmit={handleSubmit}>
            ...
            <InputBox type={"password"} label={"Password"} id={"password"} isPass={true} value={state.password} handleChange={handleChange}/>
